...
public class TC_ProductPageTest  extends BaseClass  {
	...
	public void VerifySearchProduct() throws IOException
	{
		...
		ac.enterRegisteremail(emailAddress);
		...
		registerdUserAccount productPg = new registerdUserAccount(driver);
	...
	public void VerifyBuyProduct() throws IOException
	{
		...
		registerdUserAccount prodCatPg = new registerdUserAccount(driver);
